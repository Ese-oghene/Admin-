...
<div class="col-lg-12">
<div class="form-group">
<input id="text" name="num" type="text" placeholder="Account number" required>
</div>
</div>
<div class="col-lg-12">
<div class="form-group">
<input id="text" name="ab" type="text" placeholder="Account Balance" required>
</div>
</div>

<div class="col-lg-12">
<div class="form-group">
<input id="text" name="tw" type="text" placeholder="Total Withdrawal" required>
</div>
</div>
...
<div class="form-group">
<button class="btn style1" name="upload">Upload</button>
</div>
</div>
